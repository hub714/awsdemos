...
def lambda_handler(event, context):
    ...
    if event['RequestType'] == 'Create':
        # First, SM-GT is looking for a label category. In the console, this is where you would type in something for your annotators to choose.
        # It's written as a JSON file and I've just left it in Lambda to upload as it's hard coded.
        # You can upload separately and reference an object in S3.
